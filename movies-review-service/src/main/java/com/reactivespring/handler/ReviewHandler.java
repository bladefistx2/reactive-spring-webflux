...
public class ReviewHandler {
    ...
    public @NotNull Mono<ServerResponse> addReview(ServerRequest request) {
    ...
    public @NotNull Mono<ServerResponse> getReviews(ServerRequest request) {
    ...
    public @NotNull Mono<ServerResponse> updateReview(ServerRequest request) {
    ...
    public @NotNull Mono<ServerResponse> deleteReview(ServerRequest request) {
